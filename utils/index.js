...
module.exports.throwError = function (command, threadID, messageID) {
	...
	return global.client.api.sendMessage(global.getText("utils", "throwError", ((threadSetting.hasOwnProperty("PREFIX")) ? threadSetting.PREFIX : global.config.PREFIX), command), event.threadID, event.messageID);
}
