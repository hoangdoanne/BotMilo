...
var coinscn = Math.floor(Math.random() * 4000) + 2000; //random coins khi làm ở khu công nghiệp
var coinsdv = Math.floor(Math.random() * 8000) + 2000; //random coins khi làm ở khu dịch vụ
var coinsmd = Math.floor(Math.random() * 4000) + 2000; //random coins khi làm ở mỏ dầu
var coinsq = Math.floor(Math.random() * 6000) + 2000; //random coins khi khai thác quặng
var coinsdd = Math.floor(Math.random() * 2000) + 2000; //random coins khi đào đá
var coinsdd1 = Math.floor(Math.random() * 8000) + 2000; //random coins khi đào đá
var coinsdda = Math.floor(Math.random() * 8000) + 2000; //random coins khi Phá Trinh
