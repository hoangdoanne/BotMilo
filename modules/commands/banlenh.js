module.exports.config = {
	...
	usages: "b < lệnh cần ban > u < lệnh cần gỡ > / có thể ban all lệnh bằng cách  b all / gỡ ban all lệnh thì u all",
	cooldowns: 5,
	dependencies: {
		"moment-timezone": ""
	}
...
module.exports.languages = {
  "vi": {
		...
		"banCommandSuccess": "[ THÔNG BÁO ] Đã xử lý thành công yêu cầu ban lệnh trên nhóm này",
		"unbanCommandSuccess": "[ THÔNG BÁO ] Đã xử lý thành công yêu cầu gỡ ban %1 trên nhóm này",
		"missingCommandInput": "%1 Phần command cần ban không được để trống!",
		"notExistBanCommand": "[ THÔNG BÁO ] Hiện tại ID nhóm bạn nhập chưa từng bị ban sử dụng lệnh",

	
		"returnBanCommand": "[ THÔNG BÁO ] Bạn đang yêu cầu ban sử dụng lệnh trên nhóm này\n- Các lệnh cần ban: %2\n\n❮ Thả cảm xúc tin nhắn này để xác thực ❯",
		"returnUnbanCommand": "[ THÔNG BÁO ] Bạn đang yêu cầu gỡ ban sử dụng lệnh trên nhóm này\n- Các lệnh cần gỡ ban: %2\n\n❮ Thả cảm xúc tin nhắn này để xác thực ❯"
  }
}
