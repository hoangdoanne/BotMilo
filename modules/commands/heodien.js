...
module.exports.run = async function ({ api, event, args, Users, Currencies }) {
    ...
    switch (args[0]) {
        ...
        case 'spin': {
            ...
            var items = [`${this.checkPath(2, senderID).Island.level * 1000} coins`, `${this.checkPath(2, senderID).Island.level * 3000} coins`, `${this.checkPath(2, senderID).Island.level * 5000} coins`, 'siêu trộm', 'khiên', 'tấn công', '1 lượt quay', '2 lượt quay', '5 l��ợt quay'];
