...
module.exports.handleEvent = async function({
	...
	if ((void 0 === i.resend || 0 != i.resend) && l != global.data.botID && ("message_unsend" != e.type && global.logMessage.set(g, {
		...
		if (null == m.attachment[0]) return a.sendMessage({body: `${e} đã gỡ 1 tin nhắn.\n» Nội dung: ${m.msgBody}`, mentions: [{ tag: e, id: l }]}, u); {
			let t = 0,
				s = {
					body: `${e} vừa gỡ ${m.attachment.length} tệp đính kèm. ${""!=m.msgBody?`\n» Nội dung: ${m.msgBody}`:""}`, mentions: [{ tag: e, id: l }],
					attachment: [],
					 };
